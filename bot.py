...
# FIXED: Safe init_user that won't crash on new users
...
# FIXED: TIERS_CONFIG[tier] not TIERS_CONFIG
...
# ===== SIGNAL GENERATION =====
# FIXED: TIERS_CONFIG[tier] access
...
def callback_handler(call):
    ...
    try:
        if call.data == "get_signal":
            ...
            eat_time = datetime.now(timezone(timedelta(hours=3))).strftime('%H:%M') # FIXED: added ()
